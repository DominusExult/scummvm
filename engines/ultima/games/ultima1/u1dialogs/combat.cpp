...
#include "ultima/games/ultima1/u1dialogs/combat.h"
...
bool Combat::KeypressMsg(CKeypressMsg &msg) {
	if (_direction == Shared::Maps::Direction::DIR_NONE) {
		switch (msg._keyState.keycode) {
		case Common::KEYCODE_LEFT:
		case Common::KEYCODE_KP4:
			_direction = Shared::Maps::Direction::DIR_LEFT;
			break;
		case Common::KEYCODE_RIGHT:
		case Common::KEYCODE_KP6:
			_direction = Shared::Maps::Direction::DIR_RIGHT;
			break;
		case Common::KEYCODE_UP:
		case Common::KEYCODE_KP8:
			_direction = Shared::Maps::Direction::DIR_UP;
			break;
		case Common::KEYCODE_DOWN:
		case Common::KEYCODE_KP2:
			_direction = Shared::Maps::Direction::DIR_DOWN;
			break;
		default:
			nothing();
			return true;
