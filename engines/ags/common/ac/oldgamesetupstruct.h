...
#ifndef AGS_COMMON_AC_OLDGAMESETUPSTRUCT_H
#define AGS_COMMON_AC_OLDGAMESETUPSTRUCT_H

#include "ags/common/ac/characterinfo.h"     // OldCharacterInfo, CharacterInfo
#ifdef UNUSED_CODE
#include "ags/common/ac/eventblock.h"       // EventBlock
#endif
#include "ags/common/ac/interfaceelement.h"  // InterfaceElement
#include "ags/common/ac/inventoryiteminfo.h" // InventoryItemInfo
#include "ags/common/ac/mousecursor.h"       // MouseCursor
#include "ags/common/ac/wordsdictionary.h"   // WordsDictionary
#include "ags/common/script/cc_script.h"     // ccScript
